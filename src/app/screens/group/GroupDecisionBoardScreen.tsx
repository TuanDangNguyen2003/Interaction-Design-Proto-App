...
export default function GroupDecisionBoardScreen() {
  ...
  return (
    ...
    >
      ...
      <div className="border-b border-slate-200/60 bg-white px-4 py-3 flex items-center gap-3 shrink-0">
        <button onClick={() => navigate('/group/sources')} className="text-slate-400 hover:text-slate-600 transition-colors">
      ...
      <div className="flex-1 px-5 py-5 flex flex-col min-h-0 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        <div className="shrink-0 mb-3">
          ...
          <p className="text-[14px] text-slate-500 font-medium">
            Ranked for 4 people, 3 hours, moderate budget.
          </p>
        </div>

        <button
          onClick={() => navigate('/group/filtered')}
