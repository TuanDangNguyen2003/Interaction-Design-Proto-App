...
export default function BarcelonaBackupSelectionScreen() {
        ...
        <div className="space-y-4">
          <div className="bg-white border border-emerald-200/60 rounded-[20px] p-5 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-start gap-3 mb-2">
              ...
              <div>
                ...
                <h2 className="text-[18px] font-extrabold text-slate-800">Cervecería Catalana</h2>
              </div>
            </div>
          ...
          <div className="bg-white border-2 border-primary/20 rounded-[20px] p-5 shadow-sm relative">
            <div className="mb-3">
              ...
              <h2 className="text-[18px] font-extrabold text-slate-800">Hidden Speakeasy in El Born</h2>
            </div>
