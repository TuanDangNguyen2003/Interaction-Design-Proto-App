...
import { ChevronLeft, Bookmark, MapPin, Navigation, CheckCircle2, Sparkles, Database } from 'lucide-react';
import { motion } from 'motion/react';

export default function BarcelonaSourcesScreen() {
  ...
  const sources = [
    {
      ...
      title: "Shared links and reels",
      desc: "11 TikTok and Instagram ideas",
      status: "included",
    ...
    },
    {
      ...
      desc: "5 Google Maps pins from the group",
      status: "included",
    ...
    },
    {
      ...
      desc: "14 candidates within 15 mins",
  ...
  return (
    ...
    >
      <div className="border-b border-slate-200/60 bg-white px-4 py-3 flex items-center gap-3 shrink-0">
        <button onClick={() => navigate('/group/barcelona-setup')} className="text-slate-400 hover:text-slate-600 transition-colors">
      ...
      <div className="flex-1 px-5 py-6 overflow-y-auto">
        <div className="mb-8">
          ...
          <p className="text-[15px] text-slate-500 font-medium leading-relaxed">
            TripFit is gathering what the group already saved and pairing it with realistic local hits.
          </p>
        </div>
        ...
        <div className="relative space-y-4">
          {sources.map((src, index) => (
            ...
            >
              ...
              <div className="absolute -right-6 -bottom-6 opacity-[0.03] pointer-events-none scale-150 transform rotate-12">
                {src.icon}
              </div>
            </motion.div>
          ))}
      ...
      <div className="p-5 border-t border-slate-200/60 bg-white shrink-0 space-y-4 shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.05)] relative z-10">
        ...
        <button
          onClick={() => navigate('/group/barcelona-sorting')}
