...
export default function GroupBackupSelectionScreen() {
      ...
      <div className="flex-1 px-5 py-6 overflow-y-auto">
        <div className="mb-6">
          ...
          <p className="text-[15px] text-slate-500 font-medium">
            Keep an alternative ready just in case.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="bg-white border border-emerald-200/60 rounded-[20px] p-5 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-start gap-3 mb-2">
              ...
              <div>
                ...
                <h2 className="text-[18px] font-extrabold text-slate-800">Covered Food Market</h2>
              </div>
            </div>
            <div className="bg-slate-50 rounded-xl p-3 ml-8">
              <p className="text-[13px] text-slate-600 font-medium">
                <span className="font-bold text-slate-800">Reason:</span> Best group compromise.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-primary/20 rounded-[20px] p-5 shadow-sm relative">
            <div className="absolute top-4 right-4">
              <div className="bg-primary/10 text-primary px-2.5 py-1 rounded-lg text-[11px] font-bold uppercase tracking-wider">
                Suggested Backup
              </div>
            </div>
            <h2 className="text-[18px] font-extrabold text-slate-800 mb-3">Indoor Arcade Café</h2>
            <div className="bg-primary/5 rounded-xl p-3 border border-primary/10">
              <p className="text-[13px] text-slate-700 font-medium leading-relaxed">
                <span className="font-bold text-primary">Reason:</span> Indoor, low effort, playful, and cheaper if the market is crowded.
              </p>
            </div>
          </div>
        </div>
