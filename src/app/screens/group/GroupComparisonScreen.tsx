...
export default function GroupComparisonScreen() {
    ...
    >
      ...
      <div className="flex-1 px-5 py-5 flex flex-col min-h-0 overflow-y-auto">
        ...
        <div className="space-y-4 pb-4">
          {cards.map((card) => (
            <div key={card.name} className="bg-white border border-slate-200/60 rounded-[20px] p-5 shadow-sm">
              ...
              <button
                ...
                className="w-full bg-white border border-slate-200 text-slate-700 rounded-xl py-2.5 text-[14px] font-bold hover:bg-slate-50 active:scale-[0.98] transition-all"
              >
                View details
              </button>
            </div>
      ...
      <div className="border-t border-slate-200/60 bg-white shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.05)] shrink-0">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] text-slate-600 font-medium leading-relaxed">
                Best balance of group fit, budget, weather safety, and food variety.
              </p>
            </div>
          </div>
        </div>
        <div className="p-5 space-y-2.5">
          ...
          >
            Continue with Covered Food Market
          </button>
          <button
