...
import { AlertTriangle, ChevronDown, Crown, Info, ShieldCheck, TrendingUp } from 'lucide-react';
  ...
  const cards = [
    {
      ...
      fits: [
        ...
        { label: 'Discovery value', value: 'Medium' },
      ],
      riskLabel: 'Low timing risk',
      riskIcon: <ShieldCheck className="w-4 h-4 text-emerald-500" />,
      riskColor: 'text-emerald-700 bg-emerald-50',
      tradeoff: 'Less discovery, but safest before the train',
    },
    {
      ...
      fits: [
        ...
        { label: 'Weather fit', value: 'Strong' },
        { label: 'Discovery value', value: 'Strong' },
      ],
      riskLabel: 'More transit focus',
      riskIcon: <AlertTriangle className="w-4 h-4 text-amber-500" />,
      riskColor: 'text-amber-700 bg-amber-50',
      tradeoff: 'More memorable, but less relaxed',
    },
    {
      ...
      fits: [
        ...
        { label: 'Discovery value', value: 'Weak' },
      ],
      riskLabel: 'Less distinctive',
      riskIcon: <TrendingUp className="w-4 h-4 text-rose-500" />,
      riskColor: 'text-rose-700 bg-rose-50',
      tradeoff: 'Good backup, but less cultural',
    },
  ];
