...
export default function DirectionsScreen() {
  ...
  const [isBackupRoute, setIsBackupRoute] = useState(false);
  const route = isBackupRoute
    ? {
        name: 'Les Halles Food Stop',
        walkTime: '12 min',
        pace: 'Easy backup',
        note: 'Slightly busier, but still simple and close enough before the train.',
        pin: { x: 78, y: 68 },
      }
    : {
        ...
        walkTime: '8 min',
        pace: 'Leave soon',
        note: 'Leave soon and keep enough buffer for the train.',
        pin: { x: 76, y: 29 },
      };
